...
public abstract class Hilt_SensorDataFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SensorDataFragment() {
    super();
  }

  Hilt_SensorDataFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SensorDataFragment_GeneratedInjector) this.generatedComponent()).injectSensorDataFragment(UnsafeCasts.<SensorDataFragment>unsafeCast(this));
    }
  }
