...
public abstract class Hilt_ServerConfigFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ServerConfigFragment() {
    super();
  }

  Hilt_ServerConfigFragment(int p0) {
    super(p0);
  }
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ServerConfigFragment_GeneratedInjector) this.generatedComponent()).injectServerConfigFragment(UnsafeCasts.<ServerConfigFragment>unsafeCast(this));
    }
  }
